                            ...
                            <table id="table-container" class="crancy-table__main crancy-table__main-v3">
                                <thead class="crancy-table__head">
                                    <tr>
                                        ...
                                        <th class="crancy-table__column-5 crancy-table__h5 text-center" style="width: 1%;">Aksi</th> <!-- Set width ke fit-content -->
                                    </tr>
                                </thead>
                                <tbody class="crancy-table__body">
                                        ...
                                        <td class="crancy-table__column-5 text-center">
                                            <div class="d-flex align-items-center gap-2 justify-content-center">
                                                <button type="button" class="btn-edit btn-cst btn-warning d-flex align-items-center justify-content-center w-auto px-2"
                                                    data-id="{{ $data->id }}" data-nama="{{ $data->nama }}" data-bs-toggle="modal" data-bs-target="#editKategoriModal">
                                                    Edit
                                                </button>
                                    ...
                                    @else
                                    <tr>
                                        <td colspan="5" class="text-center">Tidak ada data kategori yang ditemukan.</td>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
        ...
        <form method="POST" action="{{ route('manajemen-kategori.store') }}" class="modal-content">
            ...
            <div class="modal-body p-4">
                <div class="mb-3 form-group">
                    ...
                    <input id="nama" class="crancy-wc__form-input fw-semibold" type="text" name="nama" placeholder="Masukan nama kategori" required />
                    @if($errors->has('nama'))
                        <div class="pt-2">
...
<!-- Modal Edit Kategori -->
<div id="editKategoriModal" class="modal fade" tabindex="-1" aria-labelledby="editKategoriModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <form method="POST" action="" class="modal-content" id="editKategoriForm">
            ...
            <div class="modal-body p-4">
                <div class="mb-3 form-group">
                    ...
                    <input id="editNamaKategori" class="crancy-wc__form-input fw-semibold" type="text" name="nama" placeholder="Masukan nama kategori" required />
                    @if($errors->has('nama'))
                        <div class="pt-2">
                            <span class="form-text fw-semibold text-danger">{{ $errors->first('nama') }}</span>
                        </div>
