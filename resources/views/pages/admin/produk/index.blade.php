...
@section('content')
                                            ...
                                            @foreach ($produks as $item)
                                                @if ($item->is_deleted == 0)
                                                    <tr>
                                                        ...
                                                        <td class="crancy-table__column-2 fw-semibold">{{ $item->nama ?? '-' }}</td>
                                                        <td class="crancy-table__column-2 fw-semibold">{{ $item->kode_produk ?? '-' }}</td>
                                                        <td class="crancy-table__column-2 fw-semibold">{{ $item->kategori->nama ?? '-' }}</td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-4">
                                                                ...
                                                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                                    ...
                                                                    <form action="{{ route('manajemen-produk.destroy', $item->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
    ...
    <div id="addProdukModal" class="modal fade" tabindex="-1" aria-labelledby="addProdukModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <form method="POST" action="{{ route('manajemen-produk.store') }}" class="modal-content" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input id="harga_beli" class="crancy-wc__form-input fw-semibold" type="number" name="harga_beli" placeholder="Masukan harga beli" required />
                    </div>
                    <div class="mb-3 form-group">
                        <label class="form-label" for="harga_jual">Harga Jual <span class="text-danger">*</span></label>
                        <input id="harga_jual" class="crancy-wc__form-input fw-semibold" type="number" name="harga_jual" placeholder="Masukan harga jual" required />
                    </div>
                    <div class="mb-3 form-group">
                        <label class="form-label" for="deskripsi">Deskripsi</label>
                        <textarea id="deskripsi" class="crancy-wc__form-input fw-semibold" name="deskripsi" placeholder="Masukan deskripsi produk"></textarea>
                    </div>
                    <div class="mb-3 form-group">
                    ...
                    <div class="mb-3 form-group">
                        <label class="form-label" for="kategori_id">Pilih Kategori <span class="text-danger">*</span></label>
                        <select id="kategori_id" class="form-select crancy__item-input fw-semibold" name="kategori_id" required>
    ...
    <!-- Modal Lihat Produk -->
    @foreach ($produks as $item)
    <div id="detailProdukModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-labelledby="detailProdukModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <p id="viewKategoriProduk" class="fw-semibold">{{ $item->kategori->nama ?? 'Kategori tidak tersedia' }}</p>
                    </div>
    ...
    <!-- Modal Edit Produk -->
    @foreach ($produks as $item)
    <div id="editProdukModal-{{ $item->id }}" class="modal fade" tabindex="-1" aria-labelledby="editProdukModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <form method="POST" action="{{ route('manajemen-produk.update', $item->id) }}" class="modal-content" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-header">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3 form-group">
                        <label class="form-label" for="editNamaProduk">Nama Produk <span class="text-danger">*</span></label>
                        <input id="editNamaProduk" class="crancy-wc__form-input fw-semibold" type="text" name="nama" value="{{ $item->nama }}" required />
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input id="editHargaBeli" class="crancy-wc__form-input fw-semibold" type="number" name="harga_beli" value="{{ $item->harga_beli }}" required />
                    </div>
                    <div class="mb-3 form-group">
                        <label class="form-label" for="editHargaJual">Harga Jual <span class="text-danger">*</span></label>
                        <input id="editHargaJual" class="crancy-wc__form-input fw-semibold" type="number" name="harga_jual" value="{{ $item->harga_jual }}" required />
                    </div>
                    <div class="mb-3 form-group">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <img id="fotoPreview-{{ $item->id }}" src="{{ $item->foto }}" alt="Foto Produk" width="100" />
                    </div>

                    <div class="mb-3 form-group">
                        <label class="form-label" for="editStok">Stok <span class="text-danger">*</span></label>
                        <input id="editStok" class="crancy-wc__form-input fw-semibold" type="number" name="stok" value="{{ $item->stok }}" required />
                    </div>
                    <div class="mb-3 form-group">
                        <label class="form-label" for="editKategoriId">Pilih Kategori <span class="text-danger">*</span></label>
                        <select id="editKategoriId" class="form-select crancy__item-input fw-semibold" name="kategori_id" required>
                            @foreach ($kategoris as $kat)
