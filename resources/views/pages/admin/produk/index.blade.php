...
<!-- Modal Edit Produk -->
<div id="editProdukModal" class="modal fade" tabindex="-1" aria-labelledby="editProdukModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <form method="POST" action="" class="modal-content" id="editProdukForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="modal-header">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input id="editHargaJual" class="crancy-wc__form-input fw-semibold" type="number" name="harga_jual" required />
                </div>
                ...
                <div class="mb-3 form-group">
                    ...
                    <input id="editStok" class="crancy-wc__form-input fw-semibold" type="number" name="stok" required />
                </div>
