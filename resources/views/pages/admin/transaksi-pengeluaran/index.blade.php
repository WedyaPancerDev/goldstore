			...
			<form method="POST" action="{{ route('manajemen-transaksi-pengeluaran.store') }}" class="modal-content"
				...
				<div class="modal-body p-4">
					...
					<div class="mb-3 pt-3 form-group">
						...
						<input class="form-control quantity-input" type="text" name="quantity" placeholder="Masukkan Quantity"
							required />
					...
					<div class="mb-3 form-group">
						<label class="form-label" for="total_price">Total Harga <span class="text-danger">*</span></label>
						<input id="total_price" class="form-control" type="text" name="total_price" value="0" readonly />
					</div>
					...
					<!-- Tanggal Order -->
					<div class="mb-3 form-group">
						<label class="form-label" for="order_date">Tanggal Order <span class="text-danger">*</span></label>
					...
					<div class="modal-body p-4">
						...
						<div class="mb-3 form-group">
							...
							<input id="total_price" class="form-control" type="text" name="total_price"
								value="  {{ number_format($transaksi->total_price ?? 0, 0, ',', '.') }}" value="0" readonly />
						</div>
